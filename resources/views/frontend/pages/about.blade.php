...
<section class="home-banner-slider slider p-0">
    <div class="slick--item imagebg" style="height: 70vh !important;">
        <div class="background-image-holder">
            <img src="{{ asset('img/hospital.jpeg') }}"> 
        </div>
    ...
    <div class="floating-box" style="background-image: none; top: -10em; padding: 6em;">
        <div class="row">
            ...
            <div class="col-md-6 mb-lg-0" style="padding: 73px 65px 0 70px; background-color: #fff;">
                ...
                <span style="font-size: 20px;font-style: normal;color: #17449e !important;margin-top: 5px;">And how we get to this point</span>
                <div class="row mt-3">
                    <div class="col-md-12">
...
<div class="container text-center" style="padding-top: 10rem;padding-bottom: 4rem;">
    ...
    <span style="font-size: 20px;font-style: normal;color: #17449e;margin-top: 8px;">The largest and most respected accreditation agencies</span>
    ...
    <div style="border-color: #17449e;border-width: 2px !important;border-radius: 0px;-moz-border-radius: 0px;-webkit-border-radius: 0px;height: 35px;border-bottom: 0;width: 0;border-left-style: solid;margin-left: auto;margin-right: auto;margin-top: 2em;"></div>
</div>

<div class="container numbers" style="max-width: 1250px !important;">
    <div class="card text-center" style="background-image: url('/img/counter-bg.png'); color: #fff; padding: 50px 0px 50px 0px;">
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    <h1 class="value" style="font-size: 39px;font-weight: 700;">191</h1>
                    <span style="font-size: 20px;font-weight: 500;text-transform: none;color: #a9d0ff;">Doctors</span>
                </div>
                <div class="col-md-3">
                    <h1 style="font-size: 39px;font-weight: 700;"><span class="value">27596</span> <span>+</span></h1>
                    <span style="font-size: 20px;font-weight: 500;text-transform: none;color: #a9d0ff;">Happy Patients</span>
                </div>
                <div class="col-md-3">
                    <h1 class="value" style="font-size: 39px;font-weight: 700;">952</h1>
                    <span style="font-size: 20px;font-weight: 500;text-transform: none;color: #a9d0ff;">Medical Beds</span>
                </div>
                <div class="col-md-3">
                    <h1 class="value" style="font-size: 39px;font-weight: 700;">143</h1>
                    <span style="font-size: 20px;font-weight: 500;text-transform: none;color: #a9d0ff;">Winning Awards</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="row mt-5">
    <div class="col-md-4" style="background-image: url('/img/hospital.jpeg');background-size: cover;background-position: left;padding: 50px 0px 60px 60px;">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h3 style="font-size: 21px;color: #a6c4ff;font-weight: 500;letter-spacing: 0px;text-transform: none;">Get directions</h3>
                <div style="font-size: 19px;font-weight: 600;font-style: italic;color: #ffffff;">Find us on map</div>
            </div>
        </div>
    </div>
    <div class="col-md-4" style="background-color: #113989;background-size: cover;background-position: left;padding: 50px 0px 60px 60px;">
        <div class="d-flex align-items-center">
            <i class="fa fa-3x fa-envelope-open-text mr-3 text-white"></i>
            <div>
                <h3 style="font-size: 21px;color: #a6c4ff;font-weight: 500;letter-spacing: 0px;text-transform: none;">Contact & Appointment</h3>
                <div style="font-size: 19px;font-weight: 600;font-style: italic;color: #ffffff;">Send us an email</div>
            </div>
        </div>
    </div>
    <div class="col-md-4" style="background-image: url('/img/bg-icon-3.jpeg');background-size: cover;background-position: left;padding: 50px 0px 60px 60px;">
        <div class="d-flex align-items-center">
            <i class="fa fa-3x fa-heartbeat mr-3 text-white"></i>
            <div>
                <h3 style="font-size: 21px;color: #a6c4ff;font-weight: 500;letter-spacing: 0px;text-transform: none;">Emergency Service</h3>
